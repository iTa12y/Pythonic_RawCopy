...
class MFTEntry:
    ...
    def is_deleted(self) -> bool:
        flags = int.from_bytes(self.data[22:24], 'little')
        return not (flags & 0x01)
            ...
            if attr_type == 0x80:
                ...
                if non_res_flag == 0:
                    ...
                    while current_offset < 1024:
                        ...
                        # Read the length
                        length_bytes = self.data[current_offset:current_offset + length_size]
                        ...
                        run_offset = int.from_bytes(offset_bytes + b'\x00' * (8 - offset_size), 'little', signed=True)
